...
| Rota Externa (Gateway) | Rota Interna (Microserviço) | Destino (Host:Porta) |
| :--- | :--- | :--- |
| `/user/*` | `/api/User/*` | **User API** (`:5120`) |
| `/wallet/*` | `/api/Wallet/*` | **Wallet API** (`:5004`) |
| `/currency/*` | `/api/Currency/*` | **Currency API** (`:5002`) |
| `/chatbot/*` | `/analyze` | **Chatbot API** (`:5005`) |
