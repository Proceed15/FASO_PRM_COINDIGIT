...
class DashboardContent extends StatelessWidget {
  final List <Map <String, dynamic > > tableData = [
    ...
    {'Nome': 'Carla', 'Idade': 28, 'Cidad e': 'Belo Horizonte'},
  ];

  final List <BarChartGroupData > barGroups = [
    BarChartGroupData(x: 0, barRods: [BarChartRodData(toY: 50, color: Colors.blue)]),
    BarChartGroupData(x: 1, barRods: [BarChartRodData(toY: 75, color: Colors.b lue)]),
      ...
      child: Column(
        ...
        children: [
          ...
          Text('Gráfico de Vendas',
              style: TextSt yle(fontSize: 18, fontWeight: FontWeight.bold)),
