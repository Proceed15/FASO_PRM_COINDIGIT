  ...
  return (
    <div className="bg-[#0a1647] text-white min-h-screen items-center">
      ...
      >
        ...
        <div className="mt-[10px] w-full justify-between relative z-10 flex flex-col xl:flex-row items-center gap-12">
      ...
      <section className="px-6 md:px-16 py-20 space-y-20 bg-gradient-to-r from-[#283976] to-[#101d4b]">
        ...
        >
          ...
          <p className="text-2xl text-gray-200 text-justify max-w-2xl">
